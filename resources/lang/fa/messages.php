...
return [
    ...
    'plan_leaves_resellers_over_body' => 'آن‌ها آنچه دارند را نگه می‌دارند اما نمی‌توانند چیزی بیفزایند و تمدید روی این طرح رد می‌شود. برای یافتن آن‌ها فهرست نمایندگان را با «بیش از سقف طرح» فیلتر کنید.',
